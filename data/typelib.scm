((record (name "Header")
  ...
  (record (name "ArgBlob")
    ...
    (field (name "has_closure") (type "uint") (bits 1))
    (field (name "has_destroy") (type "uint") (bits 1))
    (field (name "scope") (type "uint") (bits 3))
    (field (name "reserved") (type "uint") (bits 19))
    (field (name "closure") (type "uint16"))
    (field (name "destroy") (type "uint16"))
  ...
  (record (name "FieldBlob")
    ...
    (field (name "null_ok") (type "uint8") (bits 1))
  ...
  (record (name "StructBlob")
    ...
    (field (name "reserved") (type "uint16") (bits 8))
    (field (name "name") (type "uint32"))
    (field (name "gtype_name") (type "uint32"))
    (field (name "gtype_init") (type "uint32"))
    (field (name "size") (type "uint32"))
