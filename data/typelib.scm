((alias (name "GQuark") (target "uint32"))
  ...
  (record (name "GParamSpecClass")
    ...
    (field (name "value_type") (type "gtype"))
    (field (name "finalize") (type "pointer"))
    (field (name "value_set_default") (type "pointer"))
    (field (name "value_validate") (type "pointer"))
    (field (name "values_cmp") (type "pointer"))
    (field (name "dummy")
      (type
        (array
          (element-type
  ...
  (record (name "GParamSpecTypeInfo")
    ...
    (field (name "instance_init") (type "pointer"))
    (field (name "value_type") (type "gtype"))
    (field (name "finalize") (type "pointer"))
    (field (name "value_set_default") (type "pointer"))
    (field (name "value_validate") (type "pointer"))
  ...
  (record (name "GTypeValueTable")
    (field (name "value_init") (type "pointer"))
    (field (name "value_free") (type "pointer"))
    (field (name "value_copy") (type "pointer"))
    (field (name "value_peek_pointer") (type "pointer"))
    (field (name "collect_format")
      (type (pointer (base-type (type "char")))))
    (field (name "collect_value") (type "pointer"))
    (field (name "lcopy_format")
      (type (pointer (base-type (type "char")))))
    (field (name "lcopy_value") (type "pointer")))
