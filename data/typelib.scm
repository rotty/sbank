((record (name "Header")
   (field (name "magic")
     (type (array (element-type (type "int8")))))
   ...
   (field (name "padding")
     (type (array (element-type (type "uint16"))))))
  ...
  (record (name "SignatureBlob")
    ...
    (field (name "arguments")
      (type (array (element-type (type "ArgBlob"))))))
  ...
  (record (name "ParamTypeBlob")
    ...
    (field (name "type")
      (type (array (element-type (type "SimpleTypeBlob"))))))
  ...
  (record (name "EnumBlob")
    ...
    (field (name "reserved2") (type "uint16"))
    (field (name "values")
      (type (array (element-type (type "ValueBlob"))))))
